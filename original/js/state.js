...
const state = {
  ...
  wallMeasurements: [], // Array to store wall measurement data
  continuousExteriorFaces: [], // Array to store detected continuous exterior faces/spans
};
...
function clearState() {
  ...
  state.continuousExteriorFaces = []; // Clear continuous exterior faces
  state.nextWorktopLabel = "A"; // Reset the label counter
  resetDrawingState();
}

// Export the state and functions
export { state, resetDrawingState, clearState };
